...
public class FileDataHandler
{
    ...
    private readonly string encryptionCodeWord = "pavimento-pavimento-pavimento-ok";
    ...
    public void Save(GameData data, string profileId) 
    {
        ...
        try 
        {
            ...
            Debug.Log("Saving data to path: " + fullPath);

            // serialize the C# game data object into Json
            string dataToStore = JsonUtility.ToJson(data, true);

            // Log serialized data
            Debug.Log("Serialized GameData: " + dataToStore);
