...
public class DataPersistenceManager : MonoBehaviour
{
    ...
    [SerializeField] private float autoSaveTimeSeconds = 600f;
    ...
    public void RegisterDataPersistenceObject(IDataPersistence dataPersistenceObj)
    {
        if (!dataPersistenceObjects.Contains(dataPersistenceObj))
        {
            dataPersistenceObjects.Add(dataPersistenceObj);
            Debug.Log($"Registered data persistence object: {dataPersistenceObj}");
        }
    }
}